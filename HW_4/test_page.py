...
def test_create_post(browser):
    ...
    sleep(1)
    assert testpage.new_post_title() == f'{testdata["title"]}', 'test_create_post FAILED!'
...
def test_contact_us(browser):
    ...
    assert testpage.get_alert_message() == 'Form successfully submitted', 'test_contact_us FAILED!'